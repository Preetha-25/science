...
function About() {
  ...
  const styles = {
    body: {
      backgroundImage: 'url("https://png.pngtree.com/thumb_back/fh260/background/20220217/pngtree-future-science-and-technology-background-design-materials-image_947097.jpg")', /* Replace 'your-image-url.jpg' with the URL of your image */
  ...
  return (
    <div style={styles.body}>
      <div style={styles.container}>
        <center><h1>About Science and Technology Blog</h1></center>
        ...
        <div style={styles.section}>
          ...
          <p style={styles.paragraph}>
            Address: 123 Innovation Lane, Tech City, TC 12345
          </p>
        </div>
      </div>
    </div>
